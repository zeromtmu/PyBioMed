...
def MakeUptoKmerList(k_values, alphabet):
...
def NormalizeVector(normalize_method, k_values, vector, kmer_list):
...
def ComputeBinNum(num_bins, position, k, numbers):
...
def MakeKmerVector(seq_list, kmer_list, rev_kmer_list, k, upto, revcomp, normalize):
    """
    ###########################################################################
