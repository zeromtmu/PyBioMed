...
def CalculateGhoseCrippenFingerprint(mol, count = False):
    res = GhoseCrippenFingerprint(mol)
    return res
...
#    print CalculateSimilarityPybel(res1,res2)
    ...
    fp = CalculatePharm2D2pointFingerprint(mol)[0]
    fp2 = CalculatePharm2D3pointFingerprint(mol)[0]
    fp3 = CalculateGhoseCrippenFingerprint(mol)
